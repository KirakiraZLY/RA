...
dir_LDAK="/home/lezh/snpher/faststorage/ldak5.2.linux"
echo "Region25 21  14600000 14700000" | cat ${dir}/RA/test/highld.txt - > ${dir}/RA/test/highld.fake
...
${dir_LDAK} --cut-genes ${dir}/RA/test/highld --bfile ${dir_RA}/data/geno_train --genefile ${dir}/RA/test/highld.fake

" > ${dir_RA}/scripts/test/highld
